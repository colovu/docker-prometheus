...
# 确保应用运行在前台
flags=("--config.file=${APP_CONF_DIR}/prometheus.yml")
flags+=("--storage.tsdb.path=${APP_DATA_DIR}")
flags+=("--web.console.libraries=${APP_HOME_DIR}/console_libraries")
flags+=("--web.console.templates=${APP_HOME_DIR}/consoles")
